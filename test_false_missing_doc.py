...
# We omit 'itinerary.pdf' to simulate a missing document required for 'ค่าโดยสารเครื่องบิน'
# We set amount to 85170.00 to avoid Amount Mismatch
payload = {
    "request_id": "RQ-69-00103",
    "amount_total": 85170.00,
    "attachments": [],
    "request_documents": [
        {
...
print(f"Sending request to {URL} with missing document data (using gpt-4o)...")
try:
    ...
    out_path = os.path.join("test_result", "test_missing_doc_output.json")
